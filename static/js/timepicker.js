...
!(function (a) {
  ...
  function c(b) {
    if (
      ...
      "now" == b.scrollDefault
        ? (b.scrollDefault = u(new Date()))
        : b.scrollDefault
        ? (b.scrollDefault = u(b.scrollDefault))
        : b.minTime && (b.scrollDefault = b.minTime),
      b.scrollDefault && (b.scrollDefault = f(b.scrollDefault, b)),
      ...
      for (var c in b.disableTimeRanges)
        b.disableTimeRanges[c] = [
          u(b.disableTimeRanges[c][0]),
          u(b.disableTimeRanges[c][1]),
        ];
      b.disableTimeRanges = b.disableTimeRanges.sort(function (a, b) {
        return a[0] - b[0];
      });
      for (var c = b.disableTimeRanges.length - 1; c > 0; c--)
        b.disableTimeRanges[c][0] <= b.disableTimeRanges[c - 1][1] &&
          ((b.disableTimeRanges[c - 1] = [
            Math.min(b.disableTimeRanges[c][0], b.disableTimeRanges[c - 1][0]),
            Math.max(b.disableTimeRanges[c][1], b.disableTimeRanges[c - 1][1]),
          ]),
          b.disableTimeRanges.splice(c, 1));
    }
    return b;
  }
  function d(b) {
    ...
    c.className && f.addClass(c.className),
      (null === c.minTime && null === c.durationTime) ||
        !c.showDuration ||
        (f.addClass("ui-timepicker-with-duration"),
        f.addClass("ui-timepicker-step-" + c.step));
    var k = c.minTime;
    "function" == typeof c.durationTime
      ? (k = u(c.durationTime()))
      : null !== c.durationTime && (k = c.durationTime);
    var m = null !== c.minTime ? c.minTime : 0,
      n = null !== c.maxTime ? c.maxTime : m + w - 1;
    m >= n && (n += w),
      n === w - 1 &&
        "string" === a.type(c.timeFormat) &&
        -1 !== c.timeFormat.indexOf("H") &&
        (n = w);
    for (
      var p = c.disableTimeRanges, q = 0, v = p.length, h = m;
      n >= h;
      h += 60 * c.step
    ) {
      var x = h,
      ...
      v > q &&
        ...
        p[q] &&
          ...
          (c.useSelect
            ? A.prop("disabled", !0)
            : A.addClass("ui-timepicker-disabled"))),
        d.append(A);
    }
    if (
      (f.data("timepicker-input", b), b.data("timepicker-list", f), c.useSelect)
    )
      b.val() && d.val(g(b.val(), c)),
        d.on("focus", function () {
      ...
      var D = c.appendTo;
      "string" == typeof D ? (D = a(D)) : "function" == typeof D && (D = D(b)),
        D.append(f),
        l(b, d),
        d.on("mousedown", "li", function () {
          b.off("focus.timepicker"),
            ...
            r(b) && (b.trigger("hideTimepicker"), f.hide());
        });
    }
  }
  function e(b, c) {
  ...
  function i(b) {
    ...
    0 === d.length &&
      ...
      (y.hide(), a(document).unbind(".ui-timepicker"));
  }
  function j(a) {
  ...
  function m(b, c) {
    if ("" !== this.value && "timepicker" != c) {
      ...
      if (
        ...
        !d.is(":focus") || (b && "change" == b.type))
      ) {
        var e = u(this.value);
        if (null === e) return d.trigger("timeFormatError"), void 0;
        var f = d.data("timepicker-settings"),
          g = !1;
        if (
          (null !== f.minTime && e < f.minTime
            ? (g = !0)
            : null !== f.maxTime && e > f.maxTime && (g = !0),
          a.each(f.disableTimeRanges, function () {
  ...
  function q(c) {
    var d = a(this),
      e = d.data("timepicker-list");
    if (!e || !b(e)) return !0;
    if (!d.data("timepicker-settings").typeaheadHighlight)
      return e.find("li").removeClass("ui-timepicker-selected"), !0;
    switch (c.keyCode) {
      case 96:
      case 97:
      case 98:
  ...
  function u(a, b) {
    ...
    var c = new RegExp(
      ...
      d = a.match(c);
    if (!d) return null;
    var e = parseInt(1 * d[1], 10),
      f = d[4],
      g = e;
    12 >= e &&
      f &&
      (g = 12 == e ? (d[4] == x.pm ? 12 : 0) : e + (d[4] == x.pm ? 12 : 0));
    var h = 1 * d[2] || 0,
      i = 1 * d[3] || 0,
      j = 3600 * g + 60 * h + i;
  ...
  var v = h(),
    ...
    y = {
          ...
          h.lang && (x = a.extend(x, h.lang)),
            ...
            h.useSelect
              ...
              : (e.prop("autocomplete", "off"),
                e.on("click.timepicker focus.timepicker", y.show),
                e.on("change.timepicker", m),
        ...
        if (
          ...
          if (
            (l.length ||
              (n(e)
                ? (l = k(e, g, u(n(e))))
                : f.scrollDefault && (l = k(e, g, f.scrollDefault))),
            l && l.length)
          ) {
          ...
          return (
            ...
            f.closeOnWindowScroll && a(document).on("scroll.ui-timepicker", i),
      ...
      setTime: function (a) {
        ...
        if (c.forceRoundTime) var d = g(a, c);
        else var d = t(u(a), c.timeFormat);
        return (
          o(b, d),
          b.data("timepicker-list") && l(b, b.data("timepicker-list")),
          this
        );
      },
      remove: function () {
    ...
    return this.length
      ? y[b]
        ? this.hasClass("ui-timepicker-input")
          ...
          : this
        : "object" != typeof b && b
        ? (a.error("Method " + b + " does not exist on jQuery.timepicker"),
          void 0)
